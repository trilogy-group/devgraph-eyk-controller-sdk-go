...
const appSettingsFixture string = `
{
    ...
    "label": {"git_repo": "https://github.com/trilogy-group/devgraph-eyk-controller-sdk-go", "team" : "deis"},
...
const appSettingsSetExpected string = `{"maintenance":true,"routable":true,"whitelist":["1.2.3.4","0.0.0.0/0"],"autoscale":{"cmd":{"min":3,"max":8,"cpu_percent":40}},"label":{"git_repo":"https://github.com/trilogy-group/devgraph-eyk-controller-sdk-go","team":"deis"}}`
const appSettingsUnsetExpected string = `{"maintenance":true,"routable":true,"whitelist":["1.2.3.4","0.0.0.0/0"],"autoscale":{"cmd":{"min":3,"max":8,"cpu_percent":40}},"label":{"git_repo":"https://github.com/trilogy-group/devgraph-eyk-controller-sdk-go","team":"deis"}}`
...
func TestAppSettingsSet(t *testing.T) {
	...
	expected := api.AppSettings{
		...
		Label: map[string]interface{}{
			"git_repo": "https://github.com/trilogy-group/devgraph-eyk-controller-sdk-go",
			"team":     "deis",
		},
		Created: "2014-01-01T00:00:00UTC",
		Updated: "2014-01-01T00:00:00UTC",
